        ...
        if (menu.hasClass('page-sidebar-menu-hover-submenu') === false) {
            menu.find('li.open').each(function(){
                if ($(this).children('.sub-menu').size() === 0) {
                    ...
                    $(this).find('> a > .arrow.open').removeClass('active open');
                }                             
            }); 
        } else {
             menu.find('li.open').removeClass('active open');
        }

        el.parents('li').each(function () {
            $(this).addClass('active');
            $(this).find('> a > span.arrow').addClass('active open');
    ...
    var handleSidebarMenu = function () {
        ...
        $('.page-sidebar').on('click', 'li > a', function (e) {
            ...
            if (keepExpand !== true) {
                ...
                parent.children('li.open').removeClass('active open');
            }

            var slideOffeset = -200;

            if (sub.is(":visible")) {
                $('.arrow', $(this)).removeClass("active open");
        ...
        $('.page-sidebar').on('click', '.sidebar-search .remove', function (e) {
            e.preventDefault();
            $('.sidebar-search').removeClass("active open");
        });
